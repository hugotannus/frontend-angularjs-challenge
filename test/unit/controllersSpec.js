...
describe('MinIONApp services', function () {
	...
	var sequenceMatcherService

	describe('Sequence matcher', function () {

		beforeEach(module('sequenceMatcher'))
		beforeEach(inject(function (_sequenceMatcherService_) {
			sequenceMatcherService = _sequenceMatcherService_
		}))
		...
		it('should count occurences of a pattern in a string', function () {
			...
			expect(sequenceMatcherService.count(needle, haystack)).toEqual(2)

			haystack = " 20 10 2 1 11 13 "

			expect(sequenceMatcherService.count(needle, haystack)).toEqual(0)

			haystack = " 21 "

			expect(sequenceMatcherService.count(needle, haystack)).toEqual(1)
